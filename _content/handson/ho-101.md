...
*10) Log in into the IBM Cloud Private CLI using the username admin and the password admin*
...
```
cd /home/icpuser/container-service-gettingstarted-wt/Stage2
```
...
[registry.ng.bluemix.net/<namespace>/hello-world] 
ea2ded433ac8: Pushed 
894eb973f4d3: Pushed 
788906ca2c7e: Pushed 
381c97ba7dc3: Pushed 
...
```  
kubectl create -f /home/icpuser/containerservice-getting-started-wt/Stage2/healthcheck.yml
```
...
a.	You can also check http://169.47.227.138:30072/healthz for status.  
...
When you are done exploring the Kubernetes dashboard, in your command-line utility, enter CTRL+C to exit the proxy command. 
...
``` 
kubectl delete -f home/icpuser/container-servicegetting-started-wt/Stage2/healthcheck.yml
```
...
2) Log in to the IBM Cloud Private Dashboard by typing admin for the user name and admin.
...
c. For the URL, enter https://raw.githubusercontent.com/ibm-cloud-architecture/refarch-cloudnative-kubernetes/master/docs/charts/bluecompute.
